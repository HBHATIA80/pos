      ...
      <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-7">
        <div className="flex flex-col gap-5 lg:flex-row lg:items-end lg:justify-between">
          <div>
            ...
            <p className="mt-2 max-w-3xl text-sm leading-6 text-slate-500">Maintain one business-scoped party master. The accounting role is a reporting/opening-balance classification only; it does not restrict whether the party can be used in sales, purchases, receipts, payments or future returns.</p>
          </div>
