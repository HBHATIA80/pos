...
function openMarketplace() {
  ...
  const popup = window.open(MARKETPLACE, 'bizbook-marketplace', 'popup=yes,width=1400,height=900,resizable=yes,scrollbars=yes')
  if (popup) popup.focus()
  else window.location.assign(MARKETPLACE)
}
