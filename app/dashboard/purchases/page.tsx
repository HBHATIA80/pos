...
const blackText = { color: '#000000' } as const
...
export default function PurchasesPage() {
  ...
  async function deleteSelectedPurchases() {
    ...
    try {
      ...
      setSelectedPurchaseIds([]); await loadPurchases()
  ...
  return <div className="mx-auto flex min-h-[calc(100vh-88px)] max-w-[1680px] flex-col gap-3 bg-slate-50/40 pb-28 lg:pb-3">
    <section className="shrink-0 overflow-hidden rounded-2xl border border-emerald-200 bg-emerald-50/80 shadow-sm">
      <div className="flex min-h-[108px] items-center justify-between gap-4 px-4 py-4 md:px-6">
        <div className="flex min-w-0 items-center gap-4">
          ...
          <div className="min-w-0 leading-tight">
            <div className="text-[15px] font-black uppercase tracking-[0.14em] !text-black" style={blackText}>INVOICE DATE</div>
            <div className="mt-1 text-[17px] font-black !text-black" style={blackText}>Choose the date for the new purchase invoice</div>
          </div>
        </div>
        <label className="relative flex shrink-0 cursor-pointer items-center rounded-xl border border-slate-300 bg-white px-4 py-3 shadow-sm transition hover:border-slate-500 hover:shadow-md">
          <span className="mr-3 text-sm font-black !text-black" style={blackText}>{displayDate}</span>
          ...
          <span className="text-lg font-black !text-black" style={blackText} aria-hidden="true">▣</span>
        </label>
      </div>
    </section>
