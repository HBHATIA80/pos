...
export default function PurchasesLayout({ children }: { children: React.ReactNode }) {
  return <div className={`${reference.transactionRoot} ${typography.purchaseTypography} ${voucherModal.voucherModalScope} ${mobile.mobileVoucher} ${mobileFinal.mobileVoucherFinal}`}>{children}<LatestVoucherScreen /></div>
}
