...
export default function SalesLayout({ children }: { children: React.ReactNode }) {
  return <div className={`${styles.salesVisual} ${matchStyles.match} ${reference.transactionRoot} ${voucherModal.voucherModalScope} ${mobile.mobileVoucher} ${mobileFinal.mobileVoucherFinal}`}>{children}<LatestVoucherScreen /></div>
}
