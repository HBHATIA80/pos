...
import AvailableStockDisplay from './available-stock-display'

export default function SalesLayout({ children }: { children: React.ReactNode }) {
  return <div className={`${styles.salesVisual} ${matchStyles.match} ${reference.transactionRoot} ${voucherModal.voucherModalScope} ${mobile.mobileVoucher} ${mobileFinal.mobileVoucherFinal} ${mobileMatch.salesMobileMatch}`}>{children}<LatestVoucherScreen /><AvailableStockDisplay /></div>
}
