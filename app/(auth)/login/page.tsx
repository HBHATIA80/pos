...
export default function LoginPage() {
  ...
  const inputClass = 'h-12 w-full rounded-xl border-2 border-slate-300 bg-white text-base font-medium text-slate-950 outline-none transition placeholder:text-slate-500 focus:border-blue-600 focus:bg-white focus:ring-4 focus:ring-blue-600/15'
    ...
    <main className="min-h-screen bg-[#f4f7fb] text-slate-950 lg:grid lg:grid-cols-[.95fr_1.05fr]">
      <section className="relative hidden min-h-screen overflow-hidden bg-gradient-to-br from-[#edf4ff] via-white to-[#e5f0ff] text-slate-950 lg:flex lg:flex-col lg:border-r-2 lg:border-slate-200">
        ...
        <div className="relative flex flex-1 flex-col px-10 py-8 xl:px-16">
          ...
          <div className="my-auto max-w-xl pb-10">
            <div className="inline-flex items-center gap-2 rounded-full border border-blue-300 bg-white px-3 py-1.5 text-xs font-black uppercase tracking-wider text-blue-800 shadow-sm"><Zap className="h-3.5 w-3.5" /> Fast · Secure · Smart</div>
      ...
      <section className="flex min-h-screen flex-col bg-[#f7faff]">
        <header className="flex min-h-20 items-center justify-between gap-4 px-5 py-4 sm:px-8 lg:px-12">
          ...
          <div className="ml-auto text-right text-sm font-semibold text-slate-700">New to BIZYBUK.IN? <Link href="/signup" className="font-black text-blue-700 hover:text-blue-900">Create a shop</Link></div>
        </header>
        <div className="flex flex-1 items-center justify-center px-5 pb-10 pt-2 sm:px-8 lg:px-12 lg:pb-16">
          <div className="w-full max-w-xl">
            <div className="mb-8 max-w-lg">
              <div className="mb-5 flex h-12 w-12 items-center justify-center rounded-2xl bg-blue-100 text-blue-800"><Smartphone className="h-6 w-6" strokeWidth={2.5} /></div>
              <p className="text-xs font-black uppercase tracking-[.18em] text-blue-800">Welcome back</p>
