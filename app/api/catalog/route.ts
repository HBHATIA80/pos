...
function cleanOptional(value?: string) { return value?.trim() || null }
...
export async function PATCH(request: Request) {
  ...
  const payload = body?.data ?? {}
  const allowed = entity.data === 'products' ? ['sku','barcode','name','description','category_id','subcategory_id','brand_id','unit_id','purchase_price','sale_price','reorder_level','is_active'] : entity.data === 'units' ? ['name','short_name','decimal_places','is_active'] : entity.data === 'subcategories' ? ['name','code','description','category_id','is_active'] : ['name','code','description','is_active']
